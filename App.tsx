...
const App: React.FC = () => {
  ...
  return (
    <>
      ...
      {isGeneratingPdf && activeTab === 'triage' && <div className="fixed top-0 left-0 w-full h-full bg-white z-[50] flex justify-center items-start overflow-auto"><div id="report-content" style={{ width: '794px', height: '1120px', padding: '30px', backgroundColor: 'white', boxSizing: 'border-box' }}><PrintableReport patient={patient} vitals={vitals} triageResult={triageResult} discriminators={discriminators} /></div></div>}
