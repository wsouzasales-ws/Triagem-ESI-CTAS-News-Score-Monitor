    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <section className="bg-white p-6 rounded-lg shadow-sm border border-slate-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div><label className="block text-xs font-bold text-slate-800 mb-1">Nº <span className="font-black text-slate-900">PRONTUÁRIO</span> <span className="text-red-500">*</span></label><input type="text" className="w-full p-2 border border-slate-600 bg-slate-800 rounded text-white font-medium focus:ring-2 focus:ring-teal-500 outline-none" value={patient.medicalRecord} onChange={e => setPatient(prev => ({...prev, medicalRecord: e.target.value}))} /></div>
